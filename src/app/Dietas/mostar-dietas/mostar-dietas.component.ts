...
import { MostarCursosDataSource, Curso } from './mostar-dietas-datasource';

@Component({
  selector: 'app-mostar-dietas',
  templateUrl: './mostar-dietas.component.html',
  styleUrls: ['./mostar-dietas.component.css']
})
export class MostarDietasComponent implements AfterViewInit, OnInit {
